...
abstract class Json {
	...
	public static Json newList() { return new JList(); }
	...
	public int size() { return this.asList().size(); }
	public Json get(String name) { return this.asObject().field(name); }
	public Json get(int index) { return this.asList().get(index); }
	public boolean getBool(String name) { return get(name).asBool(); }
	public boolean getBool(int index) { return get(index).asBool(); }
	public long getLong(String name) { return get(name).asLong(); }
	public long getLong(int index) { return get(index).asLong(); }
	public double getDouble(String name) { return get(name).asDouble(); }
	public double getDouble(int index) { return get(index).asDouble(); }
	public String getString(String name) { return get(name).asString(); }
	public String getString(int index) { return get(index).asString(); }
	public void add(String name, Json val) { this.asObject().add(name, val); }
	public void add(String name, boolean val) { this.asObject().add(name, new Json.JBool(val)); }
	public void add(String name, long val) { this.asObject().add(name, new Json.JLong(val)); }
	public void add(String name, double val) { this.asObject().add(name, new Json.JDouble(val)); }
	public void add(String name, String val) { this.asObject().add(name, new Json.JString(val)); }
	public void add(Json item) { this.asList().add(item); }
	public void add(boolean val) { this.asList().add(new Json.JBool(val)); }
	public void add(long val) { this.asList().add(new Json.JLong(val)); }
	public void add(double val) { this.asList().add(new Json.JDouble(val)); }
	public void add(String val) { this.asList().add(new Json.JString(val)); }
	public boolean asBool() { return ((JBool)this).value; }
	public long asLong() { return ((JLong)this).value; }
	public double asDouble() { return ((JDouble)this).value; }
	public String asString() { return ((JString)this).value; }
	...
	public static class StringParser {
		...
		int remaining() { return str.length() - pos; }
	...
	private static class JObject extends Json {
		...
		JObject() { fields = new ArrayList<NameVal>(); }

		public void add(String name, Json val) { fields.add(new NameVal(name, val)); }
	...
	private static class JList extends Json {
		...
		public Json get(int index) { return list.get(index); }
	...
	private static class JBool extends Json {
		boolean value;
		JBool(boolean val) { value = val; }
		void write(StringBuilder sb) { sb.append(value ? "true" : "false"); }
	}

	private static class JLong extends Json {
		long value;
		JLong(long val) { value = val; }
		void write(StringBuilder sb) { sb.append(value); }
	}

	private static class JDouble extends Json {
		double value;

		JDouble(double val) { value = val; }
		void write(StringBuilder sb) { sb.append(value); }
	...
	private static class JString extends Json {
		...
		void write(StringBuilder sb) { write(sb, value); }
	...
	private static class JNull extends Json {
		JNull() {}
		void write(StringBuilder sb) { sb.append("null"); }
	}
}